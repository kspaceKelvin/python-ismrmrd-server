...
# For now, need to set PYTHONPATH so that the module import can see the various configs
export PYTHONPATH=/opt/code/python-ismrmrd-server/config:$PYTHONPATH
